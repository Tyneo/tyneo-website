...
$modalite = htmlspecialchars($_POST['modalite'], ENT_QUOTES);
$stages = $_POST['stage'];
...
$mattermost = "Demande de formation depuis le site Internet:\n\n";
$mattermost .= "Modalités: ".$modalite."\n";
$mattermost .= "Sessions: ".join(', ', array_values($stages))."\n\n";
