...
abstract class BaseWpkbPostsManager extends AbstractBaseObjectManager {
	public function __construct(\framework\ApplicationContext $context) {
		parent::__construct($context);
		$this->setTableName('wpkb_posts');
	}

	public function getWpkbPostss() {
	...
	public function getWpkbPosts($id) {
		$query = new \framework\query\QueryBuilder();
		$query->addSelect($this->getTableName().'.*');
		$query->addTable($this->getTableName());
		if(!is_array($id)) {
	...
	protected function getUpdateQuery(\model\WpkbPosts $obj) {
	...
	protected function update(\model\WpkbPosts $obj) {
		$query = $this->getUpdateQuery($obj);
		$this->database->execute($query->toSQL());
	}

	protected function getCreateQuery(\model\WpkbPosts $obj) {
	...
	protected function create(\model\WpkbPosts $obj) {
