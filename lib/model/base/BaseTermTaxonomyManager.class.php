...
abstract class BaseTermTaxonomyManager extends AbstractBaseObjectManager {
	public function __construct(\framework\ApplicationContext $context) {
		parent::__construct($context);
		$this->setTableName('term_taxonomy');
	}
	...
	public function getTermTaxonomy($id) {
		$query = new \framework\query\QueryBuilder();
		$query->addSelect($this->getTableName().'.*');
		$query->addTable($this->getTableName());
		if(!is_array($id)) {
	...
	protected function getUpdateQuery(\model\TermTaxonomy $obj) {
	...
	protected function update(\model\TermTaxonomy $obj) {
		$query = $this->getUpdateQuery($obj);
		$this->database->execute($query->toSQL());
	}

	protected function getCreateQuery(\model\TermTaxonomy $obj) {
	...
	protected function create(\model\TermTaxonomy $obj) {
