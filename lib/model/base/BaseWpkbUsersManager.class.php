...
abstract class BaseWpkbUsersManager extends AbstractBaseObjectManager {
	public function __construct(\framework\ApplicationContext $context) {
		parent::__construct($context);
		$this->setTableName('wpkb_users');
	}

	public function getWpkbUserss() {
	...
	public function getWpkbUsers($id) {
		$query = new \framework\query\QueryBuilder();
		$query->addSelect($this->getTableName().'.*');
		$query->addTable($this->getTableName());
		if(!is_array($id)) {
	...
	protected function getUpdateQuery(\model\WpkbUsers $obj) {
	...
	protected function update(\model\WpkbUsers $obj) {
		$query = $this->getUpdateQuery($obj);
		$this->database->execute($query->toSQL());
	}

	protected function getCreateQuery(\model\WpkbUsers $obj) {
	...
	protected function create(\model\WpkbUsers $obj) {
