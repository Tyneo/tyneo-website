...
abstract class BaseWpkbCommentsManager extends AbstractBaseObjectManager {
	public function __construct(\framework\ApplicationContext $context) {
		parent::__construct($context);
		$this->setTableName('wpkb_comments');
	}

	public function getWpkbCommentss() {
	...
	public function getWpkbComments($id) {
		$query = new \framework\query\QueryBuilder();
		$query->addSelect($this->getTableName().'.*');
		$query->addTable($this->getTableName());
		if(!is_array($id)) {
	...
	protected function getUpdateQuery(\model\WpkbComments $obj) {
	...
	protected function update(\model\WpkbComments $obj) {
		$query = $this->getUpdateQuery($obj);
		$this->database->execute($query->toSQL());
	}

	protected function getCreateQuery(\model\WpkbComments $obj) {
	...
	protected function create(\model\WpkbComments $obj) {
