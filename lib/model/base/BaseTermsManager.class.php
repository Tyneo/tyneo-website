...
abstract class BaseTermsManager extends AbstractBaseObjectManager {
	...
	protected function getUpdateQuery(\model\Terms $obj) {
	...
	protected function update(\model\Terms $obj) {
		$query = $this->getUpdateQuery($obj);
		$this->database->execute($query->toSQL());
	}

	protected function getCreateQuery(\model\Terms $obj) {
	...
	protected function create(\model\Terms $obj) {
