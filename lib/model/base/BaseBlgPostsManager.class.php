...
abstract class BaseBlgPostsManager extends AbstractBaseObjectManager {
	public function __construct(\framework\ApplicationContext $context) {
		parent::__construct($context);
		$this->setTableName('blg_posts');
	}

	public function getBlgPostss() {
	...
	public function getBlgPosts($id) {
		$query = new \framework\query\QueryBuilder();
		$query->addSelect($this->getTableName().'.*');
		$query->addTable($this->getTableName());
		if(!is_array($id)) {
	...
	protected function getUpdateQuery(\model\BlgPosts $obj) {
	...
	protected function update(\model\BlgPosts $obj) {
		$query = $this->getUpdateQuery($obj);
		$this->database->execute($query->toSQL());
	}

	protected function getCreateQuery(\model\BlgPosts $obj) {
	...
	protected function create(\model\BlgPosts $obj) {
