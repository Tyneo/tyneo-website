...
/**
 * This class provides manager to manipulate WpkbTermRelationships objects.
 *
 * @author		Samuel Kauffmann <skauffmann@tyneo.net>
 * @version		1.0
 */
class WpkbTermRelationshipsManager extends base\BaseWpkbTermRelationshipsManager {
