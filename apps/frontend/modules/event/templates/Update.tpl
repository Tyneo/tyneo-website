...
<h2>Update Event</h2>
<p>This form allows you to update the existing Event...</p>
<form class="base_form" action="<?php urlFor('event_update', array('id' => $event->getId()))?>" method="post">
	...
	<input type="submit" name="Submit" value="Update" class="base_btn" />
</form>
<div class="actions">
